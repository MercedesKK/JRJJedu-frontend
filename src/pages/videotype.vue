...
import { getVideoType, createVideoType, deleteVideoType, updateVideoType,getUserData } from '~/api/manager'
...
function getData() {
    getVideoType(pageInfo).then(res => {
...
function handleSubmit() {
    const fun = modalId.value ? updateVideoType({ id: modalId.value, name: form.name,  }) : createVideoType(form)
