...
import { getChapter, createChapter, deleteChapter, updateChapter,getCourse,getUserData } from '~/api/manager'
...
function handleSubmit() {
    const fun = modalId.value ? updateChapter({ id: modalId.value, name: form.name, courseId: form.courseId }) : createChapter(form)
    ...
    <el-card shadow="never" class="border-0">
        ...
        <el-dialog v-model="addFormDialog" :title="modalTitle" width="30%" 
            ...
            <el-form :model="form"  ref="refForm" label-width="80px">
                ...
                <el-form-item prop="videoTypeId" label="课程">
