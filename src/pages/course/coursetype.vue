...
import { getCourseType, createCourseType, deleteCourseType, updateCourseType,getUserData } from '~/api/manager'
...
function getData() {
    getCourseType(pageInfo).then(res => {
...
function handleSubmit() {
    const fun = modalId.value ? updateCourseType({ id: modalId.value, name: form.name,  }) : createCourseType(form)
