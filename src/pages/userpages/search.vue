...
<div class="middle">
    <ul class="middle_types">
        <li :class="typeIndex == index ? 'type_item typeactive': 'type_item'" v-for="(item,index) in videotype" :key="index" @click="selectTyped(item.id,index)">{{ item.name }}</li>
    </ul>
</div>
