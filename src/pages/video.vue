...
import { getVideo, createVideo, deleteVideo, updateVideo,getVideoType,getUserData } from '~/api/manager'
...
const handleAvatarSuccess2 = (
    ...
    form.videoUrl = uploadFile.response.data.remoteVideoUrl
...
function handleSubmit() {
    const fun = modalId.value ? updateVideo({ id: modalId.value, name: form.name, videoTypeId: form.videoTypeId, graphicDetails: form.graphicDetails, videoUrl: form.videoUrl,price:form.price }) : createVideo(form)
    ...
    <el-card shadow="never" class="border-0">
        ...
        <el-table :data="tableData" stripe style="width: 100%">
            ...
            <el-table-column label="视频" align="center">
                <template #default="{ row }">
                    <div class="flex items-center justify-center">
                        <video src="row.videoUrl" controls></video>
            ...
            <el-table-column prop="videoTypeName" label="分类" align="center"></el-table-column>
            <el-table-column prop="graphicDetails" label="视频简介" align="center"></el-table-column>
        ...
        <el-dialog v-model="addFormDialog" :title="modalTitle" width="30%" 
            ...
            <el-form :model="form"  ref="refForm" label-width="80px">
                ...
                <el-form-item prop="price" label="价格">
                    <el-input v-model="form.name" placeholder="价格" />
                </el-form-item>


                <el-form-item prop="graphicDetails" label="视频简介">
                ...
                <el-form-item prop="videoTypeId" label="分类">
                    <el-select v-model="form.videoTypeId" placeholder="分类">
                ...
                <el-form-item prop="videoUrl" label="视频">
                    <el-upload class="avatar-uploader" :action="$elyasApi+'/file/uploadFile'"
                       ...
                       <video v-if="form.videoUrl" :src="form.videoUrl" controls></video>
